...
export const indexHTML = () => {
  ...
  <head>
      ...
      <title>EdgeSQL Starter Kit</title>
      <meta name="description" content="EdgeSQL Starter Kit" />
          ...
          <div class="content">
              ...
              <div class="content-info">
                  <div class="instructions">
                      <h4>This is an example for creating, retrieving, updating and deleting items in a EdgeSQL Database table called "posts".</h4>
                  </div>
                  <div class="control">
