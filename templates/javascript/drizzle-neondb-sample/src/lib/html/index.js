...
export const indexHTML = () => {
  ...
  <head>
      ...
      <title>Drizzle + Neon Database Sample</title>
      <meta name="description" content="Drizzle + Neon Database Sample" />
  ...
  <body>
          ...
          <div class="content">
              ...
              <div class="content-info">
                  <div class="instructions">
                      <h4>This is an example for creating, retrieving, updating and deleting items in a Neon Database table called "posts", using Drizzle as ORM.</h4>
                  </div>
                  <div class="control">
      ...
      <script type="application/javascript" defer>
          ...
          async function deleteItem(element, id) {
            ...
            alert("You've successfully deleted your post from your Neon Database table!")
          }
          ...
          async function updateItem(id) {
              ...
              await getMessage();
              alert("You've successfully updated your post in your Neon Database table!")
          }
