export const indexHTML = () => {
  ...
  <head>
      ...
      <title>Azion Edge SQL</title>
      <meta name="description" content="Azion Template Edge SQL" />
          ...
          <div class="content">
              ...
              <div class="content-info">
                  <div class="instructions">
                      <h4>This is an example for creating, retrieving, updating and deleting items in a Azion Edge SQL called Posts.</h4>
                  </div>
                  <div class="instructions">
                      <p>This template requires a Azion Edge SQL database and table to work. Go to the <a href="https://www.azion.com/en/documentation/products/guides/azion-edge-sql/" id="doclink">documentation</a> for more details.</p>
                  </div>
                  <div class="control">
