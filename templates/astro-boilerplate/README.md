...
The Azion Astro Boilerplate is designed to simplify and enhance the deployment process for Astro.js applications directly on the edge of the network.
...
This template uses Astro CLI version 2.6.4.
...
You need to activate the products separately via RTM. Review the [Azion documentation](https://www.azion.com/en/documentation/products/guides/Astro-boilerplate/) to do so.
