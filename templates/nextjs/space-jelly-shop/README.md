...
This template uses Next.js version `13.5.9`, React version `18.2.0`, and TypeScript version `4.9.5`.
...
[![Deploy Button](https://www.azion.com/button.svg)](https://console.azion.com/create/azion-community/space-jelly-shop "Deploy with Azion")
