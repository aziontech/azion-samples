# ButterCMS + Vue.js Starter Project

The **ButterCMS + Vue.js Starter Project** template creates a fully-functional [Vue.js](https://vuejs.org/guide/introduction.html) starter project, completely integrated with [ButterCMS](https://buttercms.com/), a leading headless CMS that makes collaborative content management of your application easier.
...
This template uses Vue.js version `3.2.45`.
...
Deploy your own ButterCMS + Vue.js Starter Project with Azion.

[![Deploy Button](https://www.azion.com/button.svg)](https://console.azion.com/create/buttercms/buttercms-vue-starter "Deploy with Azion")
