...
export default function MusicPlayerSlider() {
  ...
  return (
    <Box sx={{ width: '100%', overflow: 'hidden', position: 'relative', padding: '30px' }}>
      <Typography
        sx={{
          zIndex: '1',
          position: 'relative',
      ...
      >
        Example component using Material UI
      </Typography>
      <Widget>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <CoverImage>
            <img alt="can't win - Chilling Sunday" src={useBaseUrl('img/chilling-sunday.jpg')} />
          </CoverImage>
