...
The Azion Hexo Boilerplate is designed to simplify and enhance the deployment process for Hexo.js applications directly on the edge of the network.

This repository is an example of the new GitHub repository created during the deployment. For a more detailed step-by-step to deploy this template via Azion Real-Time Manager (RTM), check the [How to deploy edge applications with the Hexo Boilerplate](https://www.azion.com/en/documentation/products/guides/hexo-boilerplate/) guide.
...
3. Find the **Hexo boilerplate** card and select it.
...
For a more detailed step-by-step on declaring your secrets and using this template, check the [How to deploy edge applications with the Hexo Boilerplate](https://www.azion.com/en/documentation/products/guides/hexo-boilerplate/) guide for more details.
...
You need to activate the products separately via RTM. Review the [Azion documentation](https://www.azion.com/en/documentation/products/guides/hexo-boilerplate/) to do so.
