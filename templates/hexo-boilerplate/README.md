...
The Azion **Hexo Boilerplate** is designed to simplify and enhance the deployment process for Hexo applications directly on the edge of the network.
...
You need to activate the product separately via RTM. Review the [Azion documentation](https://www.azion.com/en/documentation/products/guides/hexo-boilerplate/) to do so.
